        ...
        <div class="p-2 container-fluid">
                ...
                <div class="row p-2 justify-content-center">
                    <div class="col-12 col-lg-10">
                        ...
                        <div class="col-12">
                                <a href="<?php echo BASE_URL; ?>/view-enrollments" class="dashboard-card secondary-tile rounded shadow border p-0 h-100 d-flex flex-column" aria-label="View enrollments for your next course">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo BASE_URL; ?>/user-administration" class="dashboard-card secondary-tile rounded shadow border p-4 h-100 d-flex flex-column" aria-label="Manage Users">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo BASE_URL; ?>/course-administration" class="dashboard-card secondary-tile rounded shadow border p-4 h-100 d-flex flex-column" aria-label="Manage Courses">
                            ...
                            <div class="col-md-4">
                                <a href="<?php echo BASE_URL; ?>/explore-courses" class="dashboard-card secondary-tile rounded shadow border p-4 h-100 d-flex flex-column" aria-label="Browse all available courses">
